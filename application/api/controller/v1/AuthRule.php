...

{
    ...
    public function authRuleAlls()

    {

        $menus = AuthRuleModel::getAuthRules();

        return setRetrunData('success', $menus);
...

    {
        ...
        $authRule_model = new AuthRuleModel();
        if ($authRule_model->allowField(true)->save($data, ['id' => $id])) {
